 ...
 * @version 1.0
 */
public abstract class ForegroundService extends BackgroundService implements Runnable {
    private static final String TAG = "ucsf:ForegroundService";
    ...
    public static class Provider extends BackgroundService.Provider {
        ...
        protected Provider(Context context, Class<? extends ForegroundService> serviceClass,
